...
check(evaluate("document.querySelector('a[href$=\"/analysis\"]')?.textContent.includes('Back to analysis')"), "Research page links back to Script Analyst")

...
export function renderReview(project) {
  if (project.error) return `${pageHeading("Originality Reviewer Agent", "Similarity review paused.", "The current script remains saved.")}${errorNotice(project.error, "retry-review", "Originality Reviewer")}`;
